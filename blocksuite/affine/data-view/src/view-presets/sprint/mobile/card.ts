...
const styles = css`
  ...
  mobile-sprint-card:has([data-editing='true']) .card-ops {
    visibility: hidden;
  }
...
export class MobileSprintCard extends SignalWatcher(
    ...
    return html` <div class="mobile-card-body">
      ${repeat(
        ...
        column => {
          ...
          return html` <mobile-sprint-cell
            .contentOnly="${false}"
...
declare global {
  interface HTMLElementTagNameMap {
    'mobile-sprint-card': MobileSprintCard;
  }
}
